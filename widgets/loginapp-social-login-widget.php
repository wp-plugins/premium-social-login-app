 ...
 */
class LoginApp_Social_Login_LA_Widget extends WP_Widget {

    /**
     *  Constructor for class LoginApp_Social_Login_LA_Widget
     */
    function LoginApp_Social_Login_LA_Widget() {
        parent::WP_Widget( 'LoginApp' /* unique id */, 'LoginApp - Social Login' /* title displayed at admin panel */, array('description' => __( 'Login or register with Facebook, Twitter, Yahoo, Google and many more', 'LoginApp' )) /* Additional parameters */ );
    }
    ...
    function widget( $args, $instance ) {
        ...
        Login_App_Widget_Helper:: login_app_widget_connect_button();
    ...
    function form( $instance ) {
        ...
        <p>
            ...
            <br /><br /><label for="<?php echo $this->get_field_id( 'hide_for_logged_in' ); ?>"><?php _e( 'Hide for logged in users:', 'LoginApp' ); ?></label>
...
add_action( 'widgets_init', create_function( '', 'return register_widget ( "LoginApp_Social_Login_LA_Widget" );' ) );
